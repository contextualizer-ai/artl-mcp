...
class TestRunClient:
    ...
    async def test_run_client_success_with_json_text(self):
        ...
        with patch('artl_mcp.client.Client', return_value=mock_client_class) as mock_client_constructor:
            with patch('builtins.print') as mock_print:
                ...
                mock_client.call_tool.assert_called_once_with("get_doi_metadata", {"doi": "10.1038/nature12373"})
    ...
    async def test_run_client_success_with_invalid_json(self):
        ...
        with patch('artl_mcp.client.Client', return_value=mock_client_class):
            with patch('builtins.print') as mock_print:
                ...
                mock_print.assert_called_once_with('{"invalid": json, "missing": quote}')
    ...
    async def test_run_client_success_with_no_text_field(self):
        ...
        mock_item = Mock()
        mock_item.text = None
        mock_item.model_dump_json = Mock(return_value='{"type": "response", "data": "test"}')
        ...
        with patch('artl_mcp.client.Client', return_value=mock_client_class):
            with patch('builtins.print') as mock_print:
                ...
                mock_print.assert_called_once_with('{"type": "response", "data": "test"}')
    ...
    async def test_run_client_success_with_multiple_items(self):
        ...
        mock_client.call_tool = AsyncMock(return_value=[mock_item1, mock_item2, mock_item3])
